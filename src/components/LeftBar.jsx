    ...
    <aside className="hidden lg:flex justify-end py-16 pr-12">
      <div className="sticky top-24 flex flex-col items-center w-48">
        ...
        <div className="flex space-x-6 mt-6 text-slate-500">
          ...
          <a href="https://github.com/Sashreekkumar" target="_blank" rel="noreferrer" className="hover:text-[#24292e]">
          ...
          <a href="https://linkedin.com/in/sashreek-kumar" target="_blank" rel="noreferrer" className="hover:text-[#FF6719]">
          ...
          <a target="_blank" href="https://www.instagram.com/camera.crafted/" aria-label="Instagram social media link" class="text-slate-500 hover:text-[#d62976] transition duration-100">
